...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* Features Section */}
      <section className="container mx-auto px-4 py-20 border-t border-border/40" aria-labelledby="features-heading">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <article className="bg-card rounded-lg p-6 border border-border shadow-card">
            ...
            <article className="bg-card rounded-lg p-6 border border-border shadow-card">
              <div className="w-12 h-12 bg-secondary/10 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
                <svg
            ...
            <article className="bg-card rounded-lg p-6 border border-border shadow-card">
              <div className="w-12 h-12 bg-accent/10 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
                <svg
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 py-20 border-t border-border/40" aria-labelledby="cta-heading">
